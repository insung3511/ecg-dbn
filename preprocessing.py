...
train = pd.read_csv('./data/final_db1', header=None)
test = pd.read_csv('./data/final_db2', header=None)
train.columns = ['sample_number', 'V5', 'V2']
test.columns = ['sample_number', 'V5', 'V2']
