...
/* DEFWFDB is the default value of the WFDB path if the WFDB environment
   ...
   If WFDB_NETFILES support is disabled, the string ". /Users/bahk_insung/SHIT_OR_FUCK/FUCK-Develop/dbn-ecg/wfdb-10.6.2/build/database" is
   usually sufficient for a default WFDB path, thus restricting the search for
   WFDB files to the current directory ("."), followed by /Users/bahk_insung/SHIT_OR_FUCK/FUCK-Develop/dbn-ecg/wfdb-10.6.2/build/database).
...
# define DEFWFDB	". /Users/bahk_insung/SHIT_OR_FUCK/FUCK-Develop/dbn-ecg/wfdb-10.6.2/build/database"
#else
# define DEFWFDB ". /Users/bahk_insung/SHIT_OR_FUCK/FUCK-Develop/dbn-ecg/wfdb-10.6.2/build/database http://physionet.org/physiobank/database"
#endif
